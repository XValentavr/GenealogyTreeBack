...
from genealogistBuildsTree.serializers import ChangeOrDeleteGenealogistBuildsTreeSerializers, \
    GetGenealogistBuildsTreeSerializers, CreateGenealogistBuildsTreeSerializers
...
class GetBuildTreeBySuperGenealogist(APIView):
    ...
    def get(request):
        ...
        """
        if request.GET.get("status") in StatusEnum:
